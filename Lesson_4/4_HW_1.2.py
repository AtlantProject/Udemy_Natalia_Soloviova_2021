...
y = (x_rad**2 + 2*x_rad - 3 + (x_rad + 1)*math.sqrt(x_rad**2 - 9))/(x_rad**2 + 2*x_rad - 3 + (x_rad - 1)*math.sqrt(x_rad**2 - 9))

# y1 = x_rad**2 + 2*x_rad - 3 + (x_rad + 1)*math.sqrt(x_rad**2 - 9)
# y2 = x_rad**2 + 2*x_rad - 3 + (x_rad - 1)*math.sqrt(x_rad**2 - 9)
# y = y1/y2
print('y={:.3f}'.format(y))

z = math.sqrt((x_rad + 3)/(x_rad - 3))
print('z={:.3f}'.format(z))
