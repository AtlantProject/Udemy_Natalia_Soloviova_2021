...
print(f"The weight of an {l[0][:-1]} is {l[1]}, the weight of an {l[2][:-1]} is {l[3]}")
print(f"The weight of an {l[0][:-1].upper()} is {l[1] * 1.2}, the weight of an {l[2][:-1].upper()} is {l[3] * 1.2}")